...
const ETAPAS: readonly EtapaTrajetoria[] = [
  {
    ...
    detalhes:
      'Os primeiros contatos com desenvolvimento profissional consolidaram a ponte entre **teoria e prática**. Aprendi a ler código legado, participar de code reviews e entregar features com **qualidade e prazo** — habilidades que só o mercado ensina de verdade.\n\nFoi nessa fase que refinei fundamentos de **JavaScript, React e boas práticas de Git**, sempre com a mentalidade de quem já conhece o impacto que um sistema instável pode causar em um ambiente crítico como o hospital. Utilizo o **Cursor** como ambiente principal de desenvolvimento.',
    conquistas: [
    ...
    stack: ['JavaScript', 'React', 'Git', 'Cursor'],
    imagem: 'estagio.jpeg',
  ...
  },
  {
    ...
    detalhes:
      'Na **Inova Rise**, atuo no desenvolvimento de produtos que unem **inteligência artificial e saúde**. Entre os principais projetos:\n\n**Unicirurgia** — mapas cirúrgicos visuais em tempo real com arquitetura **Offline-First** usando **CouchDB** e **PouchDB**, facilitando a coordenação de equipes no centro cirúrgico.\n\n**LabyWallet** — plataforma com foco em **segurança e IA** para gestão laboratorial, com persistência em **PostgreSQL**.\n\nEm todos os projetos, utilizo o **Cursor** como ambiente principal de desenvolvimento.',
    conquistas: [
      'Unicirurgia: mapas cirúrgicos com CouchDB e PouchDB',
      'LabyWallet: segurança, IA e PostgreSQL',
      'Arquitetura Offline-First em produção',
    ],
    stack: ['React', 'Next.js', 'CouchDB', 'PouchDB', 'PostgreSQL', 'Cursor'],
  ...
  },
  {
    ...
    detalhes:
      'Hoje atuo como **Desenvolvedor Full Stack** com foco em soluções para a área da saúde — unindo experiência clínica, visão de produto e engenharia de software.\n\nMinha stack atual inclui **React, Next.js, Node.js, Python, PostgreSQL e AWS**, sempre buscando entregar sistemas **performáticos, acessíveis e confiáveis**. O objetivo final permanece o mesmo desde a enfermagem: **impactar positivamente a vida das pessoas**, agora através de código que resolve problemas reais. Todo o desenvolvimento é conduzido com **Cursor** como ambiente principal.',
    conquistas: [
    ...
    stack: ['React', 'Next.js', 'Node.js', 'Python', 'PostgreSQL', 'AWS', 'Cursor'],
